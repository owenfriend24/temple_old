...
for run in 1 2 3 4; do
    ...
    fslreorient2std "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/example_func.nii.gz" 
    antsApplyTransforms -d 3 -i "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/example_func.nii.gz"  -o "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/example_func.nii.gz" -n BSpline -r /corral-repl/utexas/prestonlab/xmaze/batch/templates/MNI152_T1_1mm_brain.nii.gz -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Warp.nii.gz" -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Affine.txt" -t "${fmriprep_dir}/sub-${subject}/transforms/mask_to_func_ref_Affine.txt"
    
    fslreorient2std "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/mean_func.nii.gz"
    antsApplyTransforms -d 3 -i "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/mean_func.nii.gz" -o "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/mean_func.nii.gz" -n BSpline -r /corral-repl/utexas/prestonlab/xmaze/batch/templates/MNI152_T1_1mm_brain.nii.gz -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Warp.nii.gz" -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Affine.txt" -t "${fmriprep_dir}/sub-${subject}/transforms/mask_to_func_ref_Affine.txt"


    # mask
    echo "transforming mask"
    fslreorient2std "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/mask.nii.gz"
    antsApplyTransforms -d 3 -i "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/mask.nii.gz" -o "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/mask.nii.gz" -n NearestNeighbor -r /corral-repl/utexas/prestonlab/xmaze/batch/templates/MNI152_T1_1mm_brain.nii.gz -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Warp.nii.gz" -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Affine.txt" -t "${fmriprep_dir}/sub-${subject}/transforms/mask_to_func_ref_Affine.txt"
