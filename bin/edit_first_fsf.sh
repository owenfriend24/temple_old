...
python edit_first_fsf.py $template $out_path $subject 1 $num_vols1
python edit_first_fsf.py $template $out_path $subject 2 $num_vols2
python edit_first_fsf.py $template $out_path $subject 3 $num_vols3
python edit_first_fsf.py $template $out_path $subject 4 $num_vols4
